...
1. O desafio deve ser enviado para a pessoa no grupo do [Discord](https://discord.gg/7j7TXvc7) abrindo um ticket, no formato de `.zip` ou um link para um repositório do Github
